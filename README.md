...
This repository contains a complete AI Agent stack designed for local development and deployment of an interactive chat agent that can access GraphQL APIs.

The online deployed version is available at https://directql.up.railway.app and uses the **GitHub GraphQL API, OpenRouter, and Apollo Tools**.
